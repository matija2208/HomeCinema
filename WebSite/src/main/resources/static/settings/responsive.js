...
radioOptions.forEach(radio => {
    radio.addEventListener('change',function () {
        if (this.checked)
        {
            ...
            else if (this.value === "DELETEcontent")
            {
            ...
            {
                document.getElementById("deleteDialogYesButton").onclick=()=>{logOut();document.getElementById("deleteDialog").style.display="none"}
                document.getElementById("deleteDialogNoButton").onclick=()=>{document.getElementById("deleteDialog").style.display="none"};

                let paragraphs = document.getElementById("deleteDialog").querySelectorAll('p');
                for(let par of paragraphs)
                {
                    par.innerHTML='';
                }

                document.getElementById("deleteDialogText").innerHTML=`Do you want to Log out?`;
