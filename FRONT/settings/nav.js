...
function loadNav() {
    ...
    <nav>
        <ul style="width: 100%;display: flex; list-style-type: none; padding: 0; margin: 0; position: fixed; top:0; left:0; background-color: #1138; z-index: 1000; border-bottom: 2px solid #08c;">
